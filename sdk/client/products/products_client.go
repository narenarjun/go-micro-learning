...
type ClientService interface {
	...
	ListProduct(params *ListProductParams) (*ListProductOK, error)
...
/*
  ListProduct Return a list of products from the database
*/
func (a *Client) ListProduct(params *ListProductParams) (*ListProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewListProductParams()
	}
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListProductReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*ListProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
